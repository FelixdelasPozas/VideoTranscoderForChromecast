...
, private Ui_ProcessDialog
{
  ...
  public:
     ...
     *
     */
    explicit ProcessDialog(const std::vector<std::filesystem::path> &files,
                           const Utils::TranscoderConfiguration &config,
  ...
  private:
    ...
    std::vector<std::filesystem::path>    m_files;                /** list of file informations.                 */
